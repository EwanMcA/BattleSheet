...
const Army = () => (
  <>
    ...
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.BATTLESUIT, Keyword.BROADSIDE]}
    />
    <Unit
      ...
      keywords={[Keyword.INFANTRY, Keyword.FLY, Keyword.CHARACTER, Keyword.EPIC_HERO, Keyword.BATTLESUIT, Keyword.SHADOWSUN]}
    />
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.FLY, Keyword.CHARACTER, Keyword.BATTLESUIT, Keyword.COLDSTAR]}
    />
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.FLY, Keyword.CHARACTER, Keyword.BATTLESUIT, Keyword.ENFORCER]}
    />
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.FLY, Keyword.BATTLESUIT, Keyword.CRISIS, Keyword.FIREKNIFE]}
    />
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.FLY, Keyword.BATTLESUIT, Keyword.CRISIS, Keyword.SUNFORGE]}
    />
    <Unit
      name="Devilfish"
      stats={{
      ...
      keywords={[Keyword.VEHICLE, Keyword.FLY, Keyword.DEDICATED_TRANSPORT, Keyword.TRANSPORT, Keyword.DEVILFISH]}
    />
    <Unit
      ...
      keywords={[Keyword.VEHICLE, Keyword.WALKER, Keyword.FLY, Keyword.SMOKE, Keyword.BATTLESUIT, Keyword.GHOSTKEEL]}
    />
    <Unit
    ...
    <Unit
      ...
      keywords={[Keyword.INFANTRY, Keyword.FLY, Keyword.BATTLESUIT, Keyword.STEALTH]}
    />
  </>
);
